...
def drumriff():
    ...
    if startingGrace>1: # If there is one,
        ...
        for x in range(startingGrace): # Fill the dictionary with said drum.
            result["accent"]+=riffdrum # This will add as many of the drums as needed.
    ...
    # Thses will be put into different voices so they can get more power.
...
#    songDic["drum2"].append(otherDic["drum2"])
    songDic["drum1"].append("z"+str(int((M/M2)/(L/L3)))) if x<otherLength*2/3 else songDic["drum1"].append(otherDic["drum1"])
    songDic["drum2"].append("z"+str(int((M/M2)/(L/L3)))) if x<otherLength*2/3 else songDic["drum2"].append(otherDic["drum2"])
...
#    songDic["drum1"].append(otherDic["drum1"])
#    songDic["drum2"].append(otherDic["drum2"])
    songDic["drum1"].append("z"+str(int((M/M2)/(L/L3))))
    songDic["drum2"].append("z"+str(int((M/M2)/(L/L3))))
    songDic["state"].append(otherDic["state"][x])
    songDic["lead2"].append(["z"+str(int((M/M2)/(L/L3)))])
    songDic["chord"].append(otherDic["chord"][x])
    songDic["chordNotes"].append(otherDic["chordNotes"][x])
