...
songDic={
    ...
    "chord":[], # A list of chords being played per bar.
...
for i in range(3,bars-3):
        # Write down the bar with 1/4 chance of failure.
...
for i in range(3,bars-3):
    ...
    if songDic["fail"][i]:
        ...
        # Otherwise, write down the bar with 1/4 chance of success.
        if r.choice([True,True,True,False]):
            output+='z'+str(M*2)
        else:
            output+=j
