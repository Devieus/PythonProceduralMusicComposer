...
#    songDic["drum2"].append(otherDic["drum2"])
    songDic["drum1"].append("z"+str(int((M/M2)/(L/L3)))) if x<otherLength*2/3 else songDic["drum1"].append(otherDic["drum1"][x%2])
    songDic["drum2"].append("z"+str(int((M/M2)/(L/L3)))) if x<otherLength*2/3 else songDic["drum2"].append(otherDic["drum2"][x%2])
