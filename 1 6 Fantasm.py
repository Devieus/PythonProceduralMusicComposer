...
scales=['Hijaz','Hijazkiar','Houzam','Periaiotikos','Sengiah','Tsinganikos']
...
scalesDic={
    'Hijaz':[0,2,4,5,8,9,11,12,14,16,17,20,21,23,-1],
    'Hijazkiar':[0,3,4,5,8,9,11,12,15,16,17,20,21,23,-1],
    'Houzam':[0,3,4,7,8,9,11,12,15,16,19,20,21,23,-1],
    'Periaiotikos':[1,3,4,7,8,10,11,13,15,16,19,20,22,23,-1],
    'Sengiah':[0,2,4,7,8,9,11,12,14,16,19,20,21,23,-1],
    'Tsinganikos':[1,2,4,5,8,9,10,13,14,16,17,20,21,22,-1]
}
